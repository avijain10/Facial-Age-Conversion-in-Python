# Facial-Age-Conversion-in-Python
...
b)We have one more option of converting the google collab notebook to python code and then scheduling through apache airflow, but it seems quite complicated.
